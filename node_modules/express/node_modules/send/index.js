...
SendStream.prototype.stream = function(path, options){
  ...
  console.log("SendStream["+path+"] res.socket = ["+res.socket+"], req.connnection = ["+req.connection+"], req.socket = ["+req.socket+"]");

  if(process.env.OMOCHI_PATCH != null){

    res.on("close", function onResClose(){
      console.log("SendStream["+path+"] onResClose: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
      if(finished){ return; }
    ...
    res.on("finish", function onResFinish(){
      console.log("SendStream["+path+"] onResFinish: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
      if(finished){ return; }
   
      destroy(stream);
      finished = true;
    });
    stream.on("error", function onFileError(err){
      console.log("SendStream["+path+"] onFileError: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
      if(finished){ return; }
    ...
    stream.on("end", function onFileEnd(){
      console.log("SendStream["+path+"] onFileEnd: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
    ...
    stream.on('error', function onerror(err){
      console.log("SendStream["+path+"] streamError: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
    ...
    stream.on('end', function onend(){
      console.log("SendStream["+path+"] streamEnd: res.finished = ["+res.finished+"] , finished = ["+finished+"]");
